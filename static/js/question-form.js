$(function () {
  ...
  var $popupFeedbackOverlay = $('.js-question-overlay');
  var $popupFeedbackCall = $('.js-question-call');
  var $popupCloseLink = $('.js-popup-close', $popupFeedbackOverlay);
  var $selectTitle = $('.js-question-select');
  ...
  function chkform($form) {
    ...
    if ($('.js-required.js-filled', $form).length < $('.js-required', $form).length) {
      ...
      $('.b-button', $form).attr('disabled', 'disabled');
    } else if (!$('#question_agreement', $form).is(':checked')){
      $('.b-button', $form).attr('disabled', 'disabled');
    } else {
